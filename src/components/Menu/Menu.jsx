...
export default function Menu() {
  ...
  <a href="https://belka-mironova.github.io/IndigenousPeoplesRussia/" className={styles.grid__content} target="_blank">
    <img
      src={peoples}
  ...
  <a href="https://belka-mironova.github.io/geo-quiz/" className={styles.grid__content} target="_blank">
    <img
      src={dagestan}
  ...
  <a href="#" className={styles.grid__content} target="_blank">
    <img
      ...
      className={styles.grid__item}
    />
    {/* <!-- <div className={styles.grid__item} style="background-color: #E5C158;"></div> --> */}
    <div className={styles.grid__overlay}>
  ...
  <a href="{{url_for('contact')}}" className={styles.grid__content} target="_blank">
    <img
      ...
      className={styles.grid__item}
    />
    {/* <!-- <div className={styles.grid__item} style="background-color: #F39527;"></div> --> */}
    <div className={styles.grid__overlay}>
